...
browserOpenPromise
    .then(function (browser) {
        ...
        let emailWillTypedpromise = cTab.type("input[name='username']", "hofim87050@whyflkj.com", { delay: 200 });
        return emailWillTypedpromise;
    }).then(function () {
        let passwordWillTypedpromise = cTab.type("input[name='password']", "hofim87050", { delay: 200 });
